...
import octopus from './imgDailyTodoList/1.49octopus.svg';
...
function addNewNoteElement() {
  ...
  const crossElem = document.createTextNode('x');
...
function editNote() {
  ...
  const str = this.textContent.slice(0, this.textContent.length - 1);
