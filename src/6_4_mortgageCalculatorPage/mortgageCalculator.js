...
import mobailCart from './imgMortgageCalculator/1.35mobailCart.jpg';
// eslint-disable-next-line no-unused-vars
import USBancorpIcon from './imgMortgageCalculator/1.36USBancorpIcon.png';
...
// функция запускает другие функции для расчета по банковской процентной ставке
